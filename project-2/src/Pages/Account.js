    ...
    return (
        <form id='dd'>
            <div className="acc-section">
                ...
                <input className='ll' type="text" placeholder="Enter Name" name="firstName" required />

                <br />

                <label htmlFor="lastName"><b> Last Name </b></label>
                <input className='ll' type="text" placeholder="Last Name" name="lastName" required />

                <br />

                <label htmlFor="addressOne"><b> Address 1 </b></label>
                <input className='ll' type="text" placeholder="Address 1" name="addressOne" required />

                <br />

                <label htmlFor="addressTwo"><b> Address 2 </b></label>
                <input className='ll' type="text" placeholder="Address 2" name="addressTwo" required />

                <br />

                <label htmlFor="city"><b> City </b></label>
                <input className='ll' type="text" placeholder="City" name="city" required />
                ...
                <select name="state">
                    ...
                    <option value="Guam">Guam</option><option value="Hawaii">Hawaii</option><option value="Idaho">Idaho</option>
                    ...
                    <option value="North Dakota">North Dakota</option><option value="Northern Marianas Islands">Northern Marianas Islands</option><option value="Ohio">Ohio</option>
                    ...
                    <option value="Virgin Islands">Virgin Islands</option><option value="Washington">Washington</option>
                ...
                <input className='ll' type="text" placeholder="Zip Code" name="zip" required />

                <br />

                <label htmlFor="phone"><b> Phone Number </b></label>
                <input className='ll' type="text" placeholder="Phone Number" name="phone" required />
                
                <br />
                
                <label htmlFor="email"><b> Email </b></label>
                <input className='ll' type="text" placeholder="Email" name="email" required />
